...
<body>
	...
	<form id="formmain" action="memberJoin.do" method="post">
		<fieldset>
			<legend>필수 입력정보</legend>
			<ol>
				<li><label for="userid">아이디</label> <input id="input"
					name="member_id" type="text" required="required" autofocus /> <!-- auto focus: 처음 위치 지정 -->
				</li>
				<li><label for="pwd1">비밀번호</label> <input id="input"
					name="member_pwd" type="password" required="required" /></li>
				...
				<li><label>성별</label>
				<input type="radio" name="member_sex" id="member_sex-0" value="남자">남자
				<input type="radio" name="member_sex" id="member_sex-1" value="여자">여자
				</li>
				<li><label>주소</label><input type="text" id="sample3_postcode" placeholder="우편번호">
<input type="button" onclick="sample3_execDaumPostcode()" value="우편번호 찾기"><br>

<div id="wrap" style="display:none;border:1px solid;width:500px;height:300px;margin:5px 0;position:relative">
<img src="//t1.daumcdn.net/localimg/localimages/07/postcode/320/close.png" id="btnFoldWrap" style="cursor:pointer;position:absolute;right:0px;top:-1px;z-index:1" onclick="foldDaumPostcode()" alt="접기 버튼">
</div>
<input type="text" id="sample3_address" class="d_form large" placeholder="주소" name="member_addr">
			</ol>
		</fieldset>
