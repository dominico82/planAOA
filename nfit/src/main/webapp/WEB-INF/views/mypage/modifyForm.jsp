...
<script type="text/javascript">
	var email = document.getElementById('hidden').value;
	var strArray = email.split('@');
	var mail1 = strArray[0];
	var mail2 = strArray[1];
	document.modify_form.email1.value = mail1;
	document.modify_form.email2.value = mail2;
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="hidden" name="hidden" value="${dto.member_email}" id="hidden">
										<input id="customerEmailLocal"
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="tel" class="form-control" placeholder="휴대폰 번호를 입력하세요" value="${dto.member_tel}" 
											name="member_tel" style="width: 400px;" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'>
										</div>
									</div>
									<div class="form-group">
										<label>키, 몸무게</label>
										<div class="input-group">
											<input type="text" class="form-control" value="${dto.member_tall}cm" name="member_tall" 
											style="width: 400px;" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'><br>
											<input type="text" class="form-control" value="${dto.member_weight}kg" name="member_weight" 
									...
									<div class="form-group">
										...
										<div class="form-inline birthday">
											<input type="text" name="member_birth" id="datepicker" placeholder="클릭하세요" value="${dto.member_birth}"
									...
									<div class="form-group">
										...
										<div class="input-group postNumber">
											...
											<input type="text" id="sample2_address" placeholder="한글주소" name="member_addr" value="${dto.member_addr}">
										</div>
