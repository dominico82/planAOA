...
public class MemberDTO {
	...
	public MemberDTO(String member_id, int member_idx, String member_pwd, String member_name, String member_addr,
			String member_sex, String member_birth, String member_email, int member_tall, int member_weight,
			int member_type, int member_coin, String tel1, String tel2, String tel3, String member_tel) {
		super();
